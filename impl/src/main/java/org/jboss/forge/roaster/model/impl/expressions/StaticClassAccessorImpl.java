...
import org.jboss.forge.roaster.model.expressions.ExpressionChainLink;
...
public class StaticClassAccessorImpl<O extends JavaSource<O>,
    ...
    private ExpressionSource<O,P,?> expression;
    ...
    public ExpressionSource<O,P,?> chainExpression( ExpressionSource<O, ?, ?> child ) {
        ExpressionSource<O,P,?> cast = ( ExpressionSource<O,P,?> ) child;
