...
public class PostFixImpl<O extends JavaSource<O>,
    ...
    public PostFixImpl( PostfixOp op, OrdinalArgument<O,?,?> root ) {
        this.op = op;
        this.arg = (OrdinalArgument<O, UnaryExpression<O, P>, ?>) root;
    }
    ...
    @Override
    public ExpressionSource<O, UnaryExpression<O, P>, ?> getExpression() {
        return arg;
    }
