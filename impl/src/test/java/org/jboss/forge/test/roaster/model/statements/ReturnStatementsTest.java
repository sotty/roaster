...
public class ReturnStatementsTest
{
   ...
   public void testReturnExpr() throws Exception
   {
    ...
    @Test
    public void testReturnChain2() throws Exception
    {
        String target = "return this.foo.getBar().getRes();";
        MethodSource<JavaClassSource> method = Roaster.create( JavaClassSource.class ).addMethod( "public String foo()" );

        method.setBody( newReturn().setReturn( field( "foo" ).getter( "bar", String.class.getName() ).invoke( "getRes" ) ) );
